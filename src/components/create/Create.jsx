        ...
        <div class="flex justify-center space-x-8 mt-8 mb-8">
          <div class="flex flex-col items-center">
            <svg
              ...
              class="lucide lucide-code h-12 w-12 text-[#9500fd] mb-2"
            >
          ...
          <div class="flex flex-col items-center">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-zap h-12 w-12 text-[#9500fd] mb-2"
            >
          ...
          <div class="flex flex-col items-center">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide lucide-dollar-sign h-12 w-12 text-[#9500fd] mb-2"
            >
