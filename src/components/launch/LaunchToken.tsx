            ...
            <div className="mx-auto max-w-[48.125rem]">
              ...
              <div className="mb-6">
                ...
                <p className="mb-3 text-sm dark:text-jacarta-300">
                  The token name. Will be used in the token details and token
                  lists.
                </p>
                <input
                  type="text"
              ...
              <div className="mb-6">
                ...
                <p className="mb-3 text-sm dark:text-jacarta-300">
                  ...
                  so that users can click to learn more about it. You are
                  ...
                  <div className="flex">
                    <div>
                      ...
                      <p className="dark:text-jacarta-300">
                        Input here the list of addresses and amounts that will
                        be minted.
                      </p>
                    </div>
                  </div>
